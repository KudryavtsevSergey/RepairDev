...
$MESS['NAME_AND_LAST_NAME'] = 'Имя и Фамилия';
$MESS['COUNTRY'] = 'Страна';
$MESS['UNKNOWN'] = '(неизвестно)';

$MESS['TOP_MESSAGE'] = 'Для регистрации в системе вам необходимо заполнить поля ниже.';

$MESS['MESSAGE_OK'] = 'Регистрация прошла успешно.<br> Ваш аккаунт будет активирован в течении 48-ми часов.<br> После активации вам на почту придет уведомление.';
?>